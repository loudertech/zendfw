...
zend_class_entry *zend_eventmanager_eventscapableinterface_ce;
zend_class_entry *zend_eventmanager_sharedeventmanagerawareinterface_ce;
zend_class_entry *zend_stdlib_messageinterface_ce;
zend_class_entry *zend_eventmanager_eventmanagerawareinterface_ce;
zend_class_entry *zend_eventmanager_eventmanagerinterface_ce;
zend_class_entry *zend_mvc_applicationinterface_ce;
...
static PHP_MINIT_FUNCTION(zend)
{
	...
	ZEPHIR_INIT(Zend_EventManager_EventsCapableInterface);
	ZEPHIR_INIT(Zend_EventManager_SharedEventManagerAwareInterface);
	ZEPHIR_INIT(Zend_Stdlib_MessageInterface);
	ZEPHIR_INIT(Zend_EventManager_EventManagerAwareInterface);
	ZEPHIR_INIT(Zend_EventManager_EventManagerInterface);
	ZEPHIR_INIT(Zend_Mvc_ApplicationInterface);
